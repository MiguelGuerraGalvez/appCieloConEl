...
class ItinerarioSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $i1->nazarenos = 'Túnica negra, capa blanca y antifaz negro';
        $i1->hora_salida = '19:30:00';
        ...
        $i2->id_hermandad = 1;
        $i2->dia = 'Sábado Santo';
        $i2->hora_salida = '18:30:00';
        $i2->nazarenos = 'Túnica, capa y antifaz negros';
        ...
        $i3->nazarenos = 'Túnica de cola morada con cordón de color dorado y antifaz morado';
        $i3->hora_salida = '17:30:00';
        ...
        $i4->nazarenos = 'Túnica de cola morada con cordón de color dorado y antifaz morado';
        $i4->hora_salida = '06:30:00';
        ...
        $i5->nazarenos = 'Túnica blanca con botonadura celeste, antifaz y capa celeste y cíngulo de cordón azul y rojo';
        $i5->hora_salida = '11:00:00';
        ...
        $i6->id_hermandad = 3;
        $i6->dia = 'Jueves Santo';
        $i6->nazarenos = 'Túnica blanca con botonadura celeste, antifaz y capa celeste y cíngulo de cordón azul y rojo';
        $i6->hora_salida = '19:30:00';
        ...
        $i7->id_hermandad = 4;
        $i7->dia = 'Jueves Santo';
        $i7->nazarenos = 'Túnica negra de cola con cinturón de esparto, antifaz negro de ruán y alpargatas negras de esparto';
        $i7->hora_salida = '22:00:00';
        ...
        $i8->id_hermandad = 5;
        $i8->dia = 'Lunes Santo';
        $i8->nazarenos = 'Túnica de cola negra con cordón blanco y antifaz negro';
        $i8->hora_salida = '18:00:00';
        ...
        $i9->id_hermandad = 6;
        $i9->dia = 'Madrugá';
        $i9->nazarenos = 'Túnica y capa blanca, con antifaz de terciopelo, cíngulo y botonadura cardenal en el paso de Cristo y con antifaz de terciopelo, cíngulo y botonadura verde en el paso de palio';
        $i9->hora_salida = '00:30:00';
        ...
        $i10->nazarenos = 'Túnica blanca con cíngulo verde, capa y antifaz blancos';
        $i10->hora_salida = '19:00:00';
        ...
        $i11->nazarenos = 'Túnica blanca de cola con botonadura y antifaz rojo, ceñida por cinturón de esparto. Sobre el antifaz, centrado y a la altura del pecho figura bordado en dorado el escudo de la Hermandad. Calzado y calcetines negros';
        $i11->hora_salida = '19:00:00';
        ...
        $i12->nazarenos = 'Túnica y capa de color crema con botonadura azul, cordón azul y crema, antifaz de terciopelo azul, y guantes blancos';
        $i12->hora_salida = '19:00:00';
        ...
        $i13->nazarenos = 'Túnica negra de cola, ceñida a la cintura con cinturón de abacá amarillo y recogida sobre el brazo, antifaz y sandalias negras';
        $i13->hora_salida = '22:30:00';
