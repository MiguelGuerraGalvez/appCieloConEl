...
@section('image2')
    <a href="{{ route('consejo.carteles') }}">
        <section class="w-full h-[25vh] md:h-[50vh] lg:h-[50vh] bg-no-repeat bg-cover bg-center"  style="background-image: url(img/BOTON_CARTELES.jpg);"> <!-- La imagenestaría en el fondo de pantalla -->
...
@section('image3')
    <a href="{{ route('consejo.pregones') }}">
        <section class="w-full h-[25vh] md:h-[50vh] lg:h-[50vh] bg-no-repeat bg-cover bg-center"  style="background-image: url(img/BOTON_PREGONES.jpg);"> <!-- La imagenestaría en el fondo de pantalla -->
            <div class="flex flex-col items-center justify-center gap-8 text-center h-full text-[#FFC060] text-2xl md:text-4xl p-[2rem] md:p-[4rem] lg:p-[8rem] backdrop-blur-sm">
...
@section('image4')
    <a href="{{ route('consejo.itinerarios') }}">
        <section class="w-full h-[25vh] md:h-[50vh] lg:h-[50vh] bg-no-repeat bg-cover  bg-[position:0_20%]"  style="background-image: url(img/BOTON_ITINERARIOS.jpg);"> <!-- La imagenestaría en el fondo de pantalla -->
            <div class="flex flex-col items-center justify-center gap-8 text-center h-full text-[#FFC060] text-2xl md:text-4xl p-[2rem] md:p-[4rem] lg:p-[8rem] backdrop-blur-sm">
